...
public class comandoSpawn extends Command {
    ...
    public void execute(CommandSender sender, String[] args) {
        if((sender instanceof ProxiedPlayer)){
            ...
            String data1 = "villa";
            String data2 = "sameServer2_to_villa";
    ...
    public void sendCustomData(String data1, String playerName, String channel){
        ...
        plugin.getProxy().getScheduler().schedule(plugin, new Runnable() {
            ...
            public void run() {
                ...
                plugin.getProxy().getLogger().info(ChatColor.YELLOW+"[BungeeUtils] está enviando al jugador ("+ChatColor.RED+ playerName +ChatColor.YELLOW+") al servidor Villa para luego transportarlo a (Spawn)");
            }
