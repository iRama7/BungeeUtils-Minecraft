    ...
    public void sendCustomData(ProxiedPlayer player, String data1, String channel){
        ...
        plugin.getProxy().getScheduler().schedule(plugin, new Runnable() {
            ...
            public void run() {
                ...
                plugin.getProxy().getLogger().info(ChatColor.YELLOW+"[BungeeUtils] está enviando al jugador ("+ChatColor.RED+ player.getDisplayName() +ChatColor.YELLOW+") al servidor Villa para luego transportarlo a (mundo_parcelas)");
            }
